...
excerpt: '옵저버 패턴이 무엇이고, 어떠한 특징을 가지는지'
...
# 예시
## 여러 가지 방식으로 성적 출력하기
- ![옵저버 패턴 성적1]({{site.baseurl}}/img/designpattern-observer-score-1-classdiagram.png)
- 입력된 성적값을 출력하는 프로그램
...
- ![옵저버 패턴 문제1]({{site.baseurl}}/img/designpattern-observer-problem-1-classdiagram.png)
...
- ![옵저버 패턴 점수 해결1]({{site.baseurl}}/img/designpattern-observer-solution-1-classdiagram.png)
