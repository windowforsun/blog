...
- 실행될 기능을 캡슐화함으로써 주어진 여러 기능을 실행할 수 있는 재사용성이 높은 클래스를 설계하는 패턴
    ...
    - [행위 패턴 중 하나]({{site.baseurl}}{% link _posts/designpattern/2019-02-08-designpattern-intro.md %})
    - ![커맨드 패턴 예시1]({{site.baseurl}}/img/designpattern-command-ex-classdiagram.png)
...
# 예시
## 만능 버튼 만들기
- ![커맨드 패턴 버튼 예시 1]({{site.baseurl}}/img/designpattern-command-button-1-classdiagram.png)
...
- ![커맨트 패턴 해결 1]({{site.baseurl}}/img/designpattern-command-button-solution-1-classdiagram.png)
...
### 정리
![커맨드 패턴 버튼 정리]({{site.baseurl}}/img/designpattern-command-button-conclusion-classdiagram.png)
